...
const VoicesAndSupport = () => {
            ...
            <div className="flex gap-1">
                {[1, 2, 3, 4, 5].map((star) => (
                    <Star
                        key={star}
                        size={20}
                        className={`cursor-pointer transition-all duration-150 ${(interactive ? (hover >= star ? 'scale-105' : '') : '')
    ...
    const supporters = [
        ...
        {
            name: 'Root Digital',
            message: 'Commmunity that sparked my passion for coding and design.',
            icon: <Heart size={32} />,
                ...
                <section>
                    ...
                    >
                        <div className="text-center mb-8">
                            ...
                            <div className="w-20 h-1 bg-linear-to-r from-blue-500 to-cyan-400 mx-auto mt-3 rounded-full" />
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {supporters.map((person, i) => (
                                <motion.div
                                    ...
                                    className="bg-gray-800/80 flex-col justify-evenly backdrop-blur-sm rounded-xl p-5 text-center border border-gray-700 hover:border-blue-500/30 shadow-md"
                                >
                                    ...
                                    <button className='w-full mt-5'>
                                        <a href={person.link} target="_blank" rel="noopener noreferrer" className="hover:text-blue-300 relative w-full md:w-auto px-8 py-3 bg-linear-to-r from-blue-600 to-cyan-600 rounded-xl text-white font-semibold shadow-md hover:shadow-xl transition-all duration-300 hover:scale-[1.02] disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2">
                                            Connect on Facebook
                                        </a>
                                    </button>
                                </motion.div>
